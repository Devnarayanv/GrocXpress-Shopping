...
// Only users (not admins) can access
...
// OFFER LOGIC: products with a discount (mrp > price)
$products = mysqli_query($conn, "SELECT *, ((mrp-price)/mrp)*100 as discount FROM products WHERE mrp > price ORDER BY discount DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Arial, sans-serif; }
        ...
        header { background: var(--box-bg); box-shadow: 0 2px 10px #ff4e6411; position: sticky; top: 0; z-index: 100;}
        ...
        .logo-text p { font-size: .97rem; color: #ad6371;}
        ...
        .profile-avatar {
            ...
            margin-right:8px; vertical-align:middle; background:#eee; box-shadow:0 1px 3px #ccc;
            border:2px solid #ffe6ea; display:inline-block;
        }
        ...
        .dropdown-content {
            ...
            min-width: 170px; box-shadow: 0 8px 18px #ff4e6410;
        ...
        .dropdown-content a:hover { background: #fff0f2; color: var(--primary); }
        .main-nav {
        ...
        .product-card {
            ...
            border-radius: 16px;
            box-shadow: 0 4px 32px #ff4e6422;
            text-align: center;
            padding: 1.23rem .92rem .9rem .92rem;
            transition: transform 0.21s, box-shadow 0.23s;
            border: 1.7px solid #ffe1e6;
        }
        .product-card:hover {
            transform: translateY(-8px) scale(1.021);
            box-shadow: 0 14px 46px #ff4e6459;
            border-color: var(--primary);
        }
        .product-image { width: 100%; height: 145px; object-fit: cover;
            border-radius: 12px; cursor: pointer; background: #ffe6ed;}
...
<body>
    <header>
        ...
        <nav class="main-nav">
            ...
            <a href="deals.php" class="active">Hot Deals</a>
            <a href="contact.php">Contact</a>
        </nav>
    </header>
    <h2 class="deals-title"><i class="fas fa-tags"></i> Hot Deals & Offers</h2>
    <div class="product-grid">
        <?php while($p = mysqli_fetch_assoc($products)): ?>
            <div class="product-card">
                <div class="tag-offer">
                    <?php echo intval(round((($p['mrp']-$p['price'])/$p['mrp'])*100)); ?>% OFF
                </div>
                ...
                <div class="price-row">
                    <span>&#8377;<?php echo htmlspecialchars($p['price']); ?></span>
                    <span class="mrp">&#8377;<?php echo htmlspecialchars($p['mrp']); ?></span>
                </div>
