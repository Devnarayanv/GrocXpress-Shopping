...
// Search in groceries (singular, as in DB)
$search_query = '';
if (isset($_GET['search'])) {
    $search_query = mysqli_real_escape_string($conn, $_GET['search_query']);
    $products = mysqli_query($conn, "SELECT * FROM products WHERE LOWER(category)='grocery' AND name LIKE '%$search_query%'");
} else {
    $products = mysqli_query($conn, "SELECT * FROM products WHERE LOWER(category)='grocery'");
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Groceries - GrocXpress</title>
...
<body>
    <header>
        <div class="top-bar">
            ...
            <div class="search-bar">
                <form method="GET" action="">
                    <input type="text" name="search_query" placeholder="Search groceries..." value="<?php echo htmlspecialchars($search_query); ?>">
        ...
        <nav class="main-nav">
            ...
            <a href="groceries.php" class="active">Groceries</a>
